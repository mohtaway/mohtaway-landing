...
assert.match(html, /AW-10937612701/);
...
assert.match(html, /<helmet>\\n  <link rel=\\"canonical\\" href=\\"https:\/\/mohtaway\.github\.io\/mohtaway-landing\/\\">/);
assert.match(html, /data-work-src=\\"\{\{ w\.src \}\}\\"/);
assert.match(html, /hydrateWorkImages/);
assert.doesNotMatch(html, /<img src=\\"\{\{ w\.src \}\}\\"/);
